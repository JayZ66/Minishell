...
int handle_redirections(t_final_token **current, t_minishell *minishell, t_minishell *exit_code)
{
    int first_file;
    int last_file;
...
int	exec_loop(t_final_token **current, t_minishell *minishell, t_minishell *exit_code, int should_exit)
{
	int				pid_array[1024];
	int				index;
	int				pipefd[2];
